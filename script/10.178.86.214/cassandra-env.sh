...
JVM_OPTS="$JVM_OPTS -Djava.rmi.server.hostname=10.178.86.214"
#
# see
...
JVM_OPTS="$JVM_OPTS -javaagent:/usr/lib/jmx_prometheus_javaagent-0.3.0.jar=7070:/etc/cassandra/prometheus/cassandra.yml"
